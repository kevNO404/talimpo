...
?>
    ...
    <div class="cadastro">
        ...
        <div class="form-row">
            ...
            <label>Nome</label>
            <input type="text" class="form-control form-control-sm" name="nomefuncionario" value=<?=$linha["nome"]?> required>
            </div> 
            <div class="form-group col-md-3">
            <label>Senha</label>
            <input type="password" class="form-control form-control-sm" name="senhafuncionario" value=<?=$linha["senha"]?> required>
            </div>     
            <div class="form-group col-md-3">
            <label>CPF</label>
            ...
            <input type="text" id="rua" class="form-control form-control-sm" name="enderecofuncionario" value=<?=$linha["endereco"]?> required>
            </div>
            <div class="form-group col-md-2">
            <label>Número</label>
            <input type="text" class="form-control form-control-sm" name="numerofuncionario" value=<?=$linha["numero"]?> required>
            </div>
            <div class="form-group col-md-3">
            <label>Cidade</label>
            <input type="text" id="cidade" class="form-control form-control-sm" name="cidadefuncionario" value=<?=$linha["cidade"]?> required>
            </div>            
            <div class="form-group col-md-3">
            <label>Bairro</label>
            <input type="text" id="bairro" class="form-control form-control-sm" name="bairrofuncionario" value=<?=$linha["bairro"]?> required>
            </div>
