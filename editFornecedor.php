...
<div class="cadastro">
        <form action= php/editFornecedorTo.php method="post">
            ...
            <label>Nome</label>
            <input type="text" class="form-control form-control-sm" name="nomefornecedor" value=<?=$linha["nome"]?> required>
            </div>      
            <div class="form-group col-md-3">
            <label>CPF/CNPJ</label>
            <input type="text" class="form-control form-control-sm" name="docfornecedor" value=<?=$linha["documento"]?> required>
            </div>
            <div class="form-group col-md-3">
            <label>CEP</label>
            ...
            <div class="form-group col-md-2">
            <label>Número</label>
            <input type="text" class="form-control form-control-sm" name="numerofornecedor" value=<?=$linha["numero"]?> required>
            </div>
            <div class="form-group col-md-3">
            <label>Cidade</label>
            ...
            <input type="text" class="form-control form-control-sm" name="complementofornecedor" value=<?=$linha["complemento"]?>>
            </div>   
