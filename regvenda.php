...
<div class="pag">
    ...
    <h1><input type="text" id="valorpago" maxlength="10" name="valorpago" required onblur="calcular()"></h1>
</div>
<script>  
          function calcular(){
...
<div class="pag">
    <h2>Troco</h2>
    <h1><input type="text" id="troco" maxlength="10" name="troco" required></h1>
</div>
